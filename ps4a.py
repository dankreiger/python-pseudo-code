...
# -----------------------------------
# Helper code
WORDLIST_FILENAME = os.getcwd()+'/words.txt'
...
def playHand(hand, wordList, n):
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while any(v > 0 for k, v in hand.items()):
        # Display the hand
        ...
        # Otherwise (the input is not a single period):
            ...
            if isValidWord(userInput, hand, wordList) == False:
                ...
                print('"'+userInput+'" earned ' +
                      str(getWordScore(userInput, n))+' points. Total: '+str(totalScore)+' points')
                print()
                # Update the hand
                hand = (updateHand(hand, userInput))
    # Game is over (user entered a '.' or ran out of letters), so tell user the total score
    if gameCancelled == False:
...
def playGame(wordList):
    ...
    # if 'n'
    if userInput == 'n':
        # let user play a new (random) hand
        gameStarted = True
